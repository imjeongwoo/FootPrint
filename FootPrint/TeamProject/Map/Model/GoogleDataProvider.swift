...
class GoogleDataProvider {
  ...
  func fetchPlaces(
    ...
    var urlString = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=\(coordinate)&radius=\(radius)&key=\(googleApiKey)"
    let typesString = types.count > 0 ? types.joined(separator: "|") : "신발매장"
    urlString += "&keyword=\(typesString)"
